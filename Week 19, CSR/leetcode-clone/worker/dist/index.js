...
function processSubmission(submission) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Here you would add your actual processing logic// Simulate processing delayawait new Promise(resolve => setTimeout(resolve, 1000));
        ...
        try {
            ...
            try {
                while (1) {
                    ...
                    // @ts-ignoreawait processSubmission(submission.element);
                }
            }
            catch (error) {
